...
export const COURSES: CourseInterface[] = [
  {
    id: 1,
    description: 'Angular Core Deep Dive book',
    iconUrl:
      'https://images.unsplash.com/photo-1459369510627-9efbee1e6051?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    longDescription:
